...
import com.cloud.spring.demo.utils.RedisUtil;
...
public class RedisTest {
    ...
    public void redisStringTest() throws Exception {
        ...
        String key2 = "person2";
        String value2 = "doudou2";
        String key3 = "person3";
        String value3 = "doudou3";
    ...
    public void redisHashTest(){
        ...
        redisUtil.hset("user","userId1","{userId:1,name:doudou1,age:25}");
        redisUtil.hset("user","userId2","{userId:2,name:doudou2,age:26}");
        redisUtil.hset("user","userId3","{userId:3,name:doudou3,age:27}");
